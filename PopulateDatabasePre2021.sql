...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@FACULTY_ID,@FACULTY_NAME,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@SCHOOL_TITLE,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@DEPARTMENT_ID,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@DEPARTMENT_NAME)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@d,@d,@CREDIT_HOUR,@d,@d,@d,@d,@d,@COURSE_NAME,@d,@d,@d,@DEPARTMENT_ID,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@COFFERED_WITH,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@d,@SECTION,@d,@CAPACITY,@ENROLLED,@ROOM_ID,@d,@BLOCKED,@d,@START_TIME,@END_TIME,@ST_MW,@d,@d,@d,@Year,@Semester,@d,@d,@d,@FACULTY_ID,@d,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
