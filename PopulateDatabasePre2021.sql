...
LOAD DATA LOCAL
INFILE "/home/shafayat/Coding/django/2009 Spring to 2021 Summer.csv" 
INTO TABLE Classroom_T 
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@d,@d,@d,@d,@d,@d,@ROOM_ID,@ROOM_CAPACITY,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d)
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@SCHOOL_TITLE,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@SCHOOL_NAME,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@SCHOOL_TITLE,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@DEPARTMENT_ID,@DEPARTMENT_NAME)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@d,@d,@CREDIT_HOUR,@d,@d,@d,@d,@d,@COURSE_NAME,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@DEPARTMENT_ID,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@COFFERED_WITH,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
...
FIELDS TERMINATED BY "\t"
IGNORE 1 LINES 
(@d,@COFFER_COURSE_ID,@d,@SECTION,@d,@CAPACITY,@ENROLLED,@ROOM_ID,@d,@BLOCKED,@d,@START_TIME,@END_TIME,@ST_MW,@d,@d,@d,@Year,@Semester,@d,@d,@d,@d,@d,@d)
-- If any @variable in SET is not in above line, query wont work. Needs optimization 
